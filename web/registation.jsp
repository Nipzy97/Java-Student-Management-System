<%-- 
    Document   : register
    Created on : Feb 23, 2023, 9:55:01 AM
    Author     : Rukshana
--%>
        ...
        <div class="row">
            ...
            <div class="card text-dark mb-3" style="background-color:rgba(0, 191, 255, 0.2)">
                ...
                <div class="card-header">
                    <center><b><h4><bold>User Register</bold></h4></b></center>
                </div>

                <div class="card-body">

                    <form method="POST" action="userregistation">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" aria-label="Default" name="role" enable >
