<%-- 
    Document   : viewdegree
    Created on : May 24, 2023, 1:55:08 PM
    Author     : Admin
--%>

<%@page import="Controllers.degree"%>
    ...
    <tr>
      ...
      <tbody>
          ...
          <% 
                ...
                List<degree> DegreeList = (List<degree>) request.getAttribute("DegreeList");
                
                // Iterate over the studentList and display the records in the table
                for (degree newstudent : DegreeList) {
            %>
